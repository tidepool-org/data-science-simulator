...
def test_validator():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print("-" * 80)
        is_valid, errors = validator.validate_config_file(error_config_path)
        ...
        print("-" * 80)
        is_valid, errors = validator.validate_config_file(valid_config_path)
        ...
        # Test 3: Validate directory
        print("Test 3: Validating directory")
        print("-" * 80)
        ...
        if total_valid == 1 and total_invalid == 1:
