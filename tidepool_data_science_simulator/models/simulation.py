    ...
    def get_results_df(self):
        ...
        for time, simulation_state in self.simulation_results.items():
            ...
            row = {
                ...
                "true_carb_operation": patient_state.get_carb_operation(),
                ...
                "reported_carb_entry_time": pump_state.get_carb_entry_time(),
                "reported_carb_sync_identifier": pump_state.get_carb_sync_identifier(),
                "reported_carb_sync_version": pump_state.get_carb_sync_version(),
                "reported_carb_user_created_date": pump_state.get_carb_user_created_date(),
                "reported_carb_user_updated_date": pump_state.get_carb_user_updated_date(),
                "reported_carb_superceded_date": pump_state.get_carb_superceded_date(),
                "reported_carb_operation": pump_state.get_carb_operation(),
