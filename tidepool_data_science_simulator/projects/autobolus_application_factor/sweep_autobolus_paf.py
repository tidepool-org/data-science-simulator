...
def generate_autobolus_simulations(json_sim_base_config, base_sim_seed):
    ...
    partial_application_factors = [0.3, 0.4, 0.5, 0.6, 0.7]
    # partial_application_factors = [1]

    true_start_glucose_list = range(50, 250, 10)

    random_state = RandomState(base_sim_seed)

    for paf in partial_application_factors:
        for initial_blood_glucose in true_start_glucose_list:
            ...
            sim_id="vp={}_patient_id={}_withRC_paf={}_ibg={}".format(base_sim_seed, patient_id, paf, initial_blood_glucose)
