...
def build_risk_sim_generator(scenario_json_filepath, override_config_save_dir=None):
    ...
    SELECTED_SUBDIR = "loop_risk_v2_autobolus"  # Change this to select different subdirectories
    ...
    for risk_dir_name in risk_dirs:
        ...
        if ("TLR-1034") not in risk_dir_name:
            print(f"Skipping {risk_dir_name} as it doesn't contain 'TLR-000'")
            continue
