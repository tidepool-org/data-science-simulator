...
def f_cv(x, dt, u):
    ...
    dIsc = -Isc/tau1 + insulin_rate/(tau1*ci)  # Eq 1; note tau*ci has units of ml
...
def main():
    result_path = 'tidepool_data_science_simulator/projects/kalman_filter/icgm_analysis_vp_35_65a71e48e64827646838032c8d29d3ac91ac36da94de018be6f668559ff4f9c2_tbg=70_sbg=150.tsv'
